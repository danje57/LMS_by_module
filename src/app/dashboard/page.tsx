      ...
      {isAdmin && adminStats && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            const Icon = s.icon;
            return (
              <div key={s.label} className="bg-white dark:bg-[#1C1C1E] rounded-2xl border border-[#E5E5EA] dark:border-[#3A3A3C] p-6 space-y-4">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${s.color}`}>
                  <Icon className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-[13px] text-[#6E6E73] dark:text-[#8E8E93] font-medium">{s.label}</p>
                  <p className="text-[32px] font-semibold text-[#1D1D1F] dark:text-[#F5F5F7] leading-none mt-1">{s.value}</p>
                </div>
              </div>
            );
          })}
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: t("notStarted"), value: userStats.notStarted, icon: Circle, iconColor: "bg-[#F5F5F7] dark:bg-[#2C2C2E] text-[#6E6E73]", bar: "bg-[#0071E3]" },
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link
              ...
              className="group bg-white dark:bg-[#1C1C1E] rounded-2xl border border-[#E5E5EA] dark:border-[#3A3A3C] p-5 flex items-center gap-4 hover:border-[#0071E3]/40 hover:shadow-sm transition-all"
            >
