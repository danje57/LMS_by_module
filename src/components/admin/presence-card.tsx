  ...
  return (
    <>
      <button
        ...
        className="bg-white rounded-2xl border border-[#E5E5EA] p-6 space-y-4 text-left hover:border-[#0071E3]/40 hover:shadow-sm transition-all w-full"
      >
        ...
        <div>
          <p className="text-[13px] text-[#6E6E73] font-medium">{t("title")}</p>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[80vh] flex flex-col">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#E5E5EA]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[15px] font-semibold text-[#1D1D1F]">{t("modalTitle")}</p>
                  <p className="text-[12px] text-[#6E6E73]">{t("modalSubtitle")}</p>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-3">
              {users.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-[14px] font-medium text-[#1D1D1F]">{t("noOneOnline")}</p>
                  <p className="text-[12px] text-[#6E6E73] mt-1">{t("noOneOnlineDesc")}</p>
                </div>
              ) : (
                <div className="space-y-2">
                  {users.map((u) => (
                    <div key={u.userId} className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-[#F5F5F7] transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[13px] font-medium text-[#1D1D1F] truncate">{u.name}</p>
                        <div className="flex items-center gap-1.5 mt-0.5">
                          <BookOpen className="w-3 h-3 text-[#0071E3] shrink-0" />
                          <p className="text-[12px] text-[#6E6E73] truncate">{u.courseTitle}</p>
                        </div>
                      </div>
            ...
            {/* Footer */}
            <div className="px-6 py-3 border-t border-[#E5E5EA] flex items-center justify-between">
